...
export const wholesalerConfig: BusinessModuleConfig = {
  ...
  navigation: [
    { to: "/dashboard", label: "Distribution Dashboard", icon: LayoutDashboard },
    { to: "/inventory", label: "Batch & Stock Inventory", icon: Package },
    { to: "/sell", label: "Wholesale B2B Billing", icon: ShoppingCart },
    { to: "/cart", label: "Wholesale Cart", icon: ShoppingBag },
    { to: "/bills", label: "Tax Invoices & Challans", icon: ReceiptText },
    { to: "/customers", label: "Retailers & Pharmacy Accounts", icon: Users },
    { to: "/employees", label: "Sales & Dispatch Staff", icon: UserCheck },
    { to: "/purchases", label: "Distributor Purchases", icon: Truck },
    { to: "/credit", label: "B2B Credit & Aging", icon: CreditCard },
    { to: "/ledger", label: "Wholesale Ledger", icon: BookOpen },
    { to: "/settings", label: "Distributor Settings", icon: Settings },
  ],
  capabilities: {
    fastPosBilling: true,
