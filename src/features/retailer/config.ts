...
export const retailerConfig: BusinessModuleConfig = {
  ...
  navigation: [
    ...
    { to: "/sell", label: "POS Billing", icon: ShoppingCart },
    { to: "/cart", label: "Cart", icon: ShoppingBag },
    { to: "/bills", label: "Sales Bills", icon: ReceiptText },
    { to: "/customers", label: "Patients & Walk-ins", icon: Users },
    { to: "/employees", label: "Staff & Cashiers", icon: UserCheck },
    { to: "/purchases", label: "Stock Purchases", icon: Truck },
    { to: "/credit", label: "Patient Credit (Khata)", icon: CreditCard },
